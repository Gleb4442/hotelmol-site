        ...
        <section className="py-24">
            <div className="container mx-auto px-4">
                <div className="max-w-4xl mx-auto text-center mb-16">
                    <h2 className="font-serif text-5xl lg:text-6xl font-semibold tracking-tight mb-6">
                        {t("solutions.title")}
                    </h2>
                ...
                <Tabs defaultValue="chain" className="max-w-5xl mx-auto">
                    ...
                    <TabsContent value="single" className="space-y-12">
                        <div className="grid lg:grid-cols-2 gap-12 items-center">
                            <div>
                                <h3 className="font-serif text-3xl font-semibold mb-4">{t("solutions.single.title")}</h3>
                    ...
                    <TabsContent value="chain" className="space-y-12">
                        <div className="grid lg:grid-cols-2 gap-12 items-center">
                            <div>
                                <h3 className="font-serif text-3xl font-semibold mb-4">{t("solutions.chain.title")}</h3>
