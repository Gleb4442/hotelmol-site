                            ...
                            <div key={index} className="space-y-4">
                                ...
                                <div className="flex justify-end">
                                    <div className="flex gap-3 w-full flex-row-reverse">
                                        ...
                                        <div className="bg-primary text-white px-5 py-3 rounded-2xl rounded-tr-none shadow-md w-auto max-w-[85%] md:w-auto md:min-w-[40%] text-right">
                                ...
                                <div className="flex justify-start">
                                    <div className="flex gap-3 w-full">
                                        ...
                                        <motion.div
                                            className={cn(
                                                "group relative overflow-hidden bg-white px-5 py-3 rounded-2xl rounded-tl-none shadow-sm border border-slate-100 cursor-pointer transition-all duration-300 w-auto max-w-[85%]",
