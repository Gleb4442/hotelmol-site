            ...
            <AnimatePresence>
                {isOpen && (
                    ...
                    >
                        ...
                        {/* 4. Messages Area */}
                        <div className="flex flex-col flex-1 overflow-y-auto space-y-4 scrollbar-thin scrollbar-thumb-gray-200 scrollbar-track-transparent pointer-events-auto bg-white rounded-3xl mb-2 pt-16 px-5 pb-2 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.6),0_0_50px_-5px_rgba(0,0,0,0.3),20px_0_40px_-10px_rgba(0,0,0,0.4),-20px_0_40px_-10px_rgba(0,0,0,0.4)]">
                            {/* Welcome Bubble */}
            ...
            <AnimatePresence>
                {!isOpen && !isCookieBannerVisible && (
                    <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        className="pointer-events-auto fixed bottom-6 z-[46] hidden md:flex items-center gap-2 pl-1.5 pr-5 h-[48px] bg-[#0752A0] rounded-full border border-white/10 transition-shadow shadow-[0_8px_24px_rgba(7,82,160,0.25),0_0_25px_8px_rgba(255,255,255,0.6),0_0_35px_12px_rgba(255,255,255,0.4),0_0_45px_16px_rgba(255,255,255,0.2)] hover:shadow-[0_12px_32px_rgba(7,82,160,0.35),0_0_30px_10px_rgba(255,255,255,0.7),0_0_40px_14px_rgba(255,255,255,0.5),0_0_50px_18px_rgba(255,255,255,0.3)]"
                    >
                        <svg
