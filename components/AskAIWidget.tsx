            ...
            <AnimatePresence>
                {isOpen && (
                    ...
                    >
                        ...
                        {/* 4. Messages Area */}
                        <div className="flex-1 overflow-y-auto space-y-4 scrollbar-thin scrollbar-thumb-gray-200 scrollbar-track-transparent pointer-events-auto bg-white rounded-3xl mb-2 pt-16 shadow-lg pl-5 pr-5 pb-2">
                            {/* Welcome Bubble */}
