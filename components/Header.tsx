...
export default function Header({ onDemoClick }: HeaderProps = {}) {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 w-full pointer-events-none md:max-w-[1440px] md:mx-auto md:mt-4 md:px-6">
      ...
      <div className="md:hidden pointer-events-auto fixed top-0 left-0 right-0 h-[70px] bg-white/95 backdrop-blur-md border-b border-black/5 shadow-sm flex items-center justify-between px-4 z-[60] overflow-visible">

        {/* Mobile Left: Logo */}
        <Link href="/" className="flex items-center h-full relative" data-testid="link-home-mobile">
          <img src="/assets/hotelmol-logo-vector.svg" alt="HotelMol" className="h-[100px] object-contain absolute top-[-15px]" />
        </Link>
