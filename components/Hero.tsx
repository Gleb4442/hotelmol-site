  ...
  return (
    <>
      <section className="relative min-h-[600px] sm:min-h-[800px] lg:min-h-[calc(85vh+100px)] flex items-start lg:items-center justify-center overflow-hidden">
        ...
        <div className="absolute top-0 left-0 right-0 h-32 bg-gradient-to-b from-white/30 via-white/10 to-transparent pointer-events-none z-0" />
        <div className="absolute top-0 left-0 right-0 h-16 bg-gradient-to-b from-white/40 to-transparent pointer-events-none z-0" />
