            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <div className="relative inline-block mt-4 sm:mt-0">
                <Button
                  size="lg"
                  variant="ghost"
                  className="relative text-base px-8 h-14 backdrop-blur-md bg-blue-500/10 border border-blue-400/30 text-white hover:bg-blue-500/20 rounded-2xl shadow-[0_0_15px_rgba(59,130,246,0.3)] transition-all overflow-hidden group"
                  asChild
                ...
                <span className="absolute -top-3 -right-2 z-10 bg-blue-500 text-white text-[10px] uppercase font-bold px-2 py-0.5 rounded-full shadow-[0_0_10px_rgba(59,130,246,0.8)]">
                  new
                </span>
              </div>
            </div>
