...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO 
        title="Contact Us"
        description="Get in touch with hotelmol. Our team is ready to help you transform your hotel's guest communication with AI technology."
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        <a href="mailto:partnerships@hotelmol.com" className="hover:text-primary transition-colors">
